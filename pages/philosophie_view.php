...
<article>
    ...
    <ul>
        ...
        <li>En jouant la donne avec le logiciel de jeu des donnes</li>
    </ul>
    ...
    <ul>
        ...
        <li><strong>Peaufiner</strong> : Animé par un maître-assistant avec le programme de Parcours Bridge (coût global environ 4€ / séance)</li>
        <li><strong>Confirmer</strong> : Animé par un champion national (coût 8€ / séance)</li>
    </ul>
...
<div class="grid">
    <article>
        <h3>Démonstration de projection de donne</h3>
        <video controls src="assets/videos/Video1.mp4" style="width: 100%; border-radius: 8px;"></video>
    </article>
    <article>
        <h3>Démonstration de quizz enchères</h3>
        <video controls src="assets/videos/Video2.mp4" style="width: 100%; border-radius: 8px;"></video>
    </article>
</div>
