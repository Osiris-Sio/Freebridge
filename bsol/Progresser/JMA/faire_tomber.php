...
<article>
    ...
    <details class="level-folder">
        ...
        <div class="lesson-list">
            ...
            ?>
                <div class="lesson-item">
                    ...
                    <div class="lesson-actions">
                        ...
                        <a href="https://freebridge.fr/ddummy.htm?file=https://freebridge.fr/bsol/Progresser/JMA/21_-_Faire_tomber_les_atouts_adverses/1_-_Faire_tomber_les_atouts_adverses_sans_danger/1_-_Battre_atout/Donne_<?php echo $index + 1; ?>.lin" target="_blank" role="button" class="secondary outline">Solution</a>
                    </div>
                </div>
            <?php endforeach; ?>
            ...
            <?php
            $impasse_atout = ["Jdhxv7WV", "YUpwBXz7", "JHe5hWBT", "HY4viKuL", "3y5zFNHb"];
            ...
            ?>
                <div class="lesson-item">
                    ...
                    <div class="lesson-actions">
                        <a href="https://bridge-training.com/player/index.php?dds=<?php echo $dds; ?>" target="_blank" role="button" class="outline">Jouer</a>
                        <a href="https://freebridge.fr/ddummy.htm?file=https://freebridge.fr/bsol/Progresser/JMA/21_-_Faire_tomber_les_atouts_adverses/1_-_Faire_tomber_les_atouts_adverses_sans_danger/3_-_Impasse_a_l'atout_d'abord/Donne_<?php echo $index + 1; ?>.lin" target="_blank" role="button" class="secondary outline">Solution</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <details class="level-folder">
        ...
        <div class="lesson-list">
            ...
            foreach ($tours2 as $index => $dds):
                $file_name = ($index == 25) ? "Donne_26².lin" : "Donne_" . ($index + 1) . ".lin";
            ?>
                <div class="lesson-item">
                    <span>Donne <?php echo $index + 1; ?></span>
                    <div class="lesson-actions">
            ...
            <?php
            $tour1 = ["znads6Qu", "RsnwJUxL", "GQn8qWZ7", "E4sD2T65", "ZV4rmfYu", "GNhRZWJk", "iGTh9rDN"];
            ...
            ?>
                <div class="lesson-item">
                    ...
                    <div class="lesson-actions">
                        <a href="https://bridge-training.com/player/index.php?dds=<?php echo $dds; ?>" target="_blank" role="button" class="outline">Jouer</a>
                        <a href="https://freebridge.fr/ddummy.htm?file=https://freebridge.fr/bsol/Progresser/JMA/21_-_Faire_tomber_les_atouts_adverses/2_-_Retrait_partiel_des_atouts/3_-_Un_tour_d'atout_seulement/Donne_<?php echo $index + 1; ?>.lin" target="_blank" role="button" class="secondary outline">Solution</a>
                    </div>
                </div>
            <?php endforeach; ?>
            ...
            foreach ($debarras as $index => $dds):
                ...
                $folder = ($actual_num == 3) ? "4_-_Les_tours_de_debarras777" : "4_-_Les_tours_de_debarras";
            ?>
                <div class="lesson-item">
            ...
            <?php
            $tours2_maitre = ["vEdJfKeY", "JSxiM5WZ", "xHgX6r7u", "zYsR2WJj", "KCh4pRF8", "dQtPAWJf", "BAHneKkf", "VMdBwp7L", "zmBp7JtR", "JcKb98FL", "kSsAvH2z"];
            ...
            ?>
                <div class="lesson-item">
                    ...
                    <div class="lesson-actions">
                        <a href="https://bridge-training.com/player/index.php?dds=<?php echo $dds; ?>" target="_blank" role="button" class="outline">Jouer</a>
                        <a href="https://freebridge.fr/ddummy.htm?file=https://freebridge.fr/bsol/Progresser/JMA/21_-_Faire_tomber_les_atouts_adverses/2_-_Retrait_partiel_des_atouts/6_-_2_tours_d'atout_et_coupe_d'un_atout_maitre_au_Mort/Donne_<?php echo $index + 1; ?>.lin" target="_blank" role="button" class="secondary outline">Solution</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <details class="level-folder">
        ...
        <div class="lesson-list">
            ...
            <?php
            $axxx = ["kGHTBVq2", "8eYmLSxs", "c8dkAB7H", "eH8TmMwz", "Buh4qN8x", "V8bYJrjG"];
            ...
            ?>
                <div class="lesson-item">
                    ...
                    <div class="lesson-actions">
                        <a href="https://bridge-training.com/player/index.php?dds=<?php echo $dds; ?>" target="_blank" role="button" class="outline">Jouer</a>
                        <a href="https://freebridge.fr/ddummy.htm?file=https://freebridge.fr/bsol/Progresser/JMA/21_-_Faire_tomber_les_atouts_adverses/3_-_Coup_a_blanc_a_l'atout/4_-_Avec_Axxx_en_face_de_xxxx/Donne_<?php echo $index + 1; ?>.lin" target="_blank" role="button" class="secondary outline">Solution</a>
                    </div>
                </div>
            <?php endforeach; ?>
            ...
            <?php
            $axxxxx = ["mnzkGsbw", "VACJNFc9", "P9MLK7fr", "qXPc5NeV", "pvywbDLd"];
            ...
            <?php
            $tierce = ["CjcTp8mX", "egT4vqBG", "pMm8y4Pg", "AxqFdUC7", "Qvpsa5Uq"];
            ...
            ?>
                <div class="lesson-item">
                    ...
                    <div class="lesson-actions">
                        <a href="https://bridge-training.com/player/index.php?dds=<?php echo $dds; ?>" target="_blank" role="button" class="outline">Jouer</a>
                        <a href="https://freebridge.fr/ddummy.htm?file=https://freebridge.fr/bsol/Progresser/JMA/21_-_Faire_tomber_les_atouts_adverses/3_-_Coup_a_blanc_a_l'atout/6_-_Malgre_la_tierce_majeure_a_l'atout/Donne_<?php echo $index + 1; ?>.lin" target="_blank" role="button" class="secondary outline">Solution</a>
                    </div>
                </div>
            <?php endforeach; ?>
            ...
            <?php
            $autres = ["bm98N7Ct", "cDsEjWu4", "WFTter4k", "nNpjZJrX", "isFPJQW9"];
            ...
            ?>
                <div class="lesson-item">
                    ...
                    <div class="lesson-actions">
                        <a href="https://bridge-training.com/player/index.php?dds=<?php echo $dds; ?>" target="_blank" role="button" class="outline">Jouer</a>
                        <a href="https://freebridge.fr/ddummy.htm?file=https://freebridge.fr/bsol/Progresser/JMA/21_-_Faire_tomber_les_atouts_adverses/3_-_Coup_a_blanc_a_l'atout/7_-_Autres/Donne_<?php echo $index + 1; ?>.lin" target="_blank" role="button" class="secondary outline">Solution</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
