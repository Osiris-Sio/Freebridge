            ...
            <?php for ($i = 1; $i <= 39; $i++): ?>
                <div class="lesson-item">
                    ...
                    <div class="lesson-actions">
                        ...
                        <a href="https://freebridge.fr/ddummy.htm?file=https://freebridge.fr/bsol/Progresser/JMSA/16_-_Choix_de_la_couleur_a_affranchir/Donne_<?php echo $i; ?>.lin" target="_blank" role="button" class="secondary outline">Solution</a>
                    </div>
                </div>
            <?php endfor; ?>
        </div>
