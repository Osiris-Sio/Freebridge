...
window.convertXML = function (data) {
  ...
  json.event.participants = participantsObj
  const pair = []
  participantsObj.pair = pair

  const participantsNode = xmlDoc.getElementsByTagName('PARTICIPANTS')[0]
  const pnodes = participantsNode.getElementsByTagName('PAIR')
