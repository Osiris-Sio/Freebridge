...
<article>
    <header>
        <h1>Affranchissement de levées de longueur en défense</h1>
    </header>

    <div class="course-header">
        <a href="assets/pdf/defense-sa-debuter/Les levées de longueur de la défense.pdf" target="_blank" role="button" class="secondary">
