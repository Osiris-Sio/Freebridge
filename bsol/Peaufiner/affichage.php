<!--Maître A Body Start-->
			<div id="divMain" __AddCode="Spread DIV Tag" __AddCode="Maître A DIV Tag" style="background:#c2ff00;margin-left:auto;margin-right:auto;position:relative;width:960px;height:700px;/*Spread DIV Style*//*Maître A DIV Style*/">
			<!--Page Start-->
			
			<!--Preamble for Logo.JPG - Bitmap intégré pic_30-->
			<img alt="P" src="logo.jpg" __AddCode="here" style="position:absolute;left:40px;top:10px;width:200px;height:30px;/*Add Style*/">
			...
			<!-- Tableau table_1 -->
			<table border="1" class="OBJ-1" __AddCode="here" style="position:absolute;left:307px;top:0px;width:300px;height:120px;/*Add Style*/">
			...
			<!--Postamble for Tableau table_1-->
			
	
			<!--Preamble for Zone de texte - NORD txt_3
			<div class="OBJ-2" __AddCode="here" style="position:absolute;left:307px;top:0px;width:300px;height:40px;overflow:hidden;/*Add Style*/">
				<p class="Corps P-1"><span class="C-1">NORD</span></p>
			</div>
			<!--Postamble for Zone de texte - NORD txt_3-->
			

			<!-- Tableau table_5 -->

			<!--Preamble for Tableau table_5-->
			<table border="1" class="OBJ-3" __AddCode="here" style="position:absolute;left:60px;top:50px;width:140px;height:45px;text-align:center;/*Add Style*/">
				...
				<tr style="height:15px;">
					<td class="TC-3"  style="/* CellStyle */">
						<span class="C-1">W</span>
					</td>
					<td class="TC-1"  style="/* CellStyle */">
						<span class="C-1"></span>
					</td>
			...
			<!--Postamble for Tableau table_5-->
			

			<!-- Tableau table_6 -->

			<!--Preamble for Tableau table_6-->
			<table border="1" class="OBJ-1" __AddCode="here" style="position:absolute;left:701px;top:0px;width:209px;height:140px;text-align:center;/*Add Style*/">
				<col style="width:52px;">
				<col style="width:52px;">
				<col style="width:52px;">
				<col style="width:52px;">
				<tr style="height:10px;">
					<td class="TC-4"  style="class="Corps-de-tableau P-1"/* CellStyle */">
						<span class="C-1">S</span>
					</td>
					<td class="TC-5"  style="/* CellStyle */">
						<span class="C-1">O</span>
					</td>
					<td class="TC-4"  style="/* CellStyle */">
						<span class="C-1">N</span>
					</td>
					<td class="TC-5"  style="/* CellStyle */">
						<span class="C-1">E</span>
			...
			<!--Postamble for Tableau table_6-->
			
			<!-- Tableau table_7 -->
			<!--Preamble for Tableau table_7-->
			<table border="1" class="OBJ-6" __AddCode="here" style="position:absolute;left:660px;top:590px;width:233px;height:20px;/*Add Style*/">
				<col style="width:68px;">
				<col style="width:68px;">
				<col style="width:68px;">
				<tr style="height:20px;">
					<td colspan="2" class="TC-8"  style="/* CellStyle */">
						<span class="C-2">Contrat 3SA par</span>
					</td>
					<td class="TC-8"  style="/* CellStyle */">
						<span class="C-2">S</span>
					</td>
				</tr>
			</table>
			<!--Postamble for Tableau table_7-->
		

			<!-- Tableau table_8 -->
			<!--Preamble for Tableau table_8-->
			<table border="1" class="OBJ-6" __AddCode="here" style="position:absolute;left:660px;top:610px;width:266px;height:20px;/*Add Style*/">
				...
				<tr style="height:20px;">
					<td class="TC-8"  style="/* CellStyle */">
						<span class="C-2">Levées NS</span>
					</td>
					<td class="TC-8"  style="/* CellStyle */">
						<span class="C-2"><br></span>
					</td>
					<td class="TC-8"  style="/* CellStyle */">
						<span class="C-2">Levées EO</span>
					</td>
					<td class="TC-8"  style="/* CellStyle */">
						<span class="C-2"><br></span>
					</td>
			...
			<!--Postamble for Tableau table_8-->
			

			<!-- Coeur.JPG - Bitmap intégré pic_1 -->
			<!--Preamble for Coeur.JPG - Bitmap intégré pic_1-->
			<img alt="C" src="Coeur.jpg" __AddCode="here" style="position:absolute;left:308px;top:54px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Coeur.JPG - Bitmap intégré pic_1-->
			

			<!-- Pique.JPG - Bitmap intégré pic_2 -->
			<!--Preamble for Pique.JPG - Bitmap intégré pic_2-->
			<img alt="P" src="Pique.jpg" __AddCode="here" style="position:absolute;left:308px;top:1px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Pique.JPG - Bitmap intégré pic_2-->
			

			<!-- Carreau.JPG - Bitmap intégré pic_3 -->
			<!--Preamble for Carreau.JPG - Bitmap intégré pic_3-->
			<img alt="K" src="Carreau.jpg" __AddCode="here" style="position:absolute;left:308px;top:108px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Carreau.JPG - Bitmap intégré pic_3-->
			

			<!-- Trefle.JPG - Bitmap intégré pic_4 -->
			<!--Preamble for Trefle.JPG - Bitmap intégré pic_4-->
			<img alt="T" src="Trefle.jpg" __AddCode="here" style="position:absolute;left:308px;top:162px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Trefle.JPG - Bitmap intégré pic_4-->
			
			<!--Preamble for Zone de texte - OUEST txt
			<div class="OBJ-7" __AddCode="here" style="position:absolute;left:0px;top:265px;width:301px;height:41px;overflow:hidden;/*Add Style*/">
				<p class="Corps P-1"><span class="C-1">OUEST</span></p>
				<p class="Corps P-1"><span class="C-1"><br></span></p>
			</div>
			<!--Postamble for Zone de texte - OUEST txt_7-->
			

			<!-- Tableau table_2 -->

			<!--Preamble for Tableau table_2-->
			<table border="1" class="OBJ-1" __AddCode="here" style="position:absolute;left:0px;top:215px;width:300px;height:160px;/*Add Style*/">
				<col style="width:28px;">
				<col style="width:28px;">
				<col style="width:28px;">
				<col style="width:28px;">
			...
			<!--Postamble for Tableau table_2-->
			<!-- Coeur.JPG - Bitmap intégré pic_1 -->
			<!--Preamble for Coeur.JPG - Bitmap intégré pic_1-->
			<img alt="C" src="Coeur.jpg" __AddCode="here" style="position:absolute;left:1px;top:269px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Coeur.JPG - Bitmap intégré pic_1-->

			<!-- Pique.JPG - Bitmap intégré pic_2 -->
			<!--Preamble for Pique.JPG - Bitmap intégré pic_2-->
			<img alt="P" src="Pique.jpg" __AddCode="here" style="position:absolute;left:1px;top:216px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Pique.JPG - Bitmap intégré pic_2-->

			<!-- Carreau.JPG - Bitmap intégré pic_3 -->
			<!--Preamble for Carreau.JPG - Bitmap intégré pic_3-->
			<img alt="K" src="Carreau.jpg" __AddCode="here" style="position:absolute;left:1px;top:323px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Carreau.JPG - Bitmap intégré pic_3-->
			

			<!-- Trefle.JPG - Bitmap intégré pic_4 -->
			<!--Preamble for Trefle.JPG - Bitmap intégré pic_4-->
			<img alt="T" src="Trefle.jpg" __AddCode="here" style="position:absolute;left:1px;top:377px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Trefle.JPG - Bitmap intégré pic_4-->

			<!-- Tableau table_3 -->
			<!--Preamble for Tableau table_3-->
			<table border="1" class="OBJ-1" __AddCode="here" style="position:absolute;left:612px;top:215px;width:321px;height:160px;/*Add Style*/">
				<col style="width:28px;">
				<col style="width:28px;">
				<col style="width:28px;">
				<col style="width:28px;">
			...
			<!--Postamble for Tableau table_3-->
						
			<!-- Coeur.JPG - Bitmap intégré pic_1 -->
			<!--Preamble for Coeur.JPG - Bitmap intégré pic_1-->
			<img alt="C" src="Coeur.jpg" __AddCode="here" style="position:absolute;left:613px;top:269px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Coeur.JPG - Bitmap intégré pic_1-->
			
			<!-- Pique.JPG - Bitmap intégré pic_2 -->
			<!--Preamble for Pique.JPG - Bitmap intégré pic_2-->
			<img alt="P" src="Pique.jpg" __AddCode="here" style="position:absolute;left:613px;top:216px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Pique.JPG - Bitmap intégré pic_2-->
			

			<!-- Carreau.JPG - Bitmap intégré pic_3 -->
			<!--Preamble for Carreau.JPG - Bitmap intégré pic_3-->
			<img alt="K" src="Carreau.jpg" __AddCode="here" style="position:absolute;left:613px;top:323px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Carreau.JPG - Bitmap intégré pic_3-->

			<!-- Trefle.JPG - Bitmap intégré pic_4 -->
			<!--Preamble for Trefle.JPG - Bitmap intégré pic_4-->
			<img alt="T" src="Trefle.jpg" __AddCode="here" style="position:absolute;left:613px;top:377px;width:28px;height:52px;/*Add Style*/">
			<!--Postamble for Trefle.JPG - Bitmap intégré pic_4-->


			<!-- Tableau table_4 -->
			<!--Preamble for Tableau table_4-->
			<table border="1" class="OBJ-1" __AddCode="here" style="position:absolute;left:307px;top:430px;width:300px;height:160px;/*Add Style*/">
				<col style="width:28px;">
				<col style="width:28px;">
				<col style="width:28px;">
				<col style="width:28px;">
			...
			<!--Postamble for Tableau table_4-->
			
			<!-- Coeur.JPG - Bitmap intégré pic_1 -->
			<img alt="C" src="Coeur.jpg" __AddCode="here" style="position:absolute;left:308px;top:487px;width:28px;height:52px;/*Add Style*/">
			
			<!-- Pique.JPG - Bitmap intégré pic_2 -->
			<img alt="P" src="Pique.jpg" __AddCode="here" style="position:absolute;left:308px;top:431px;width:28px;height:52px;/*Add Style*/">
			
			<!-- Carreau.JPG - Bitmap intégré pic_3 -->
			<img alt="K" src="Carreau.jpg" __AddCode="here" style="position:absolute;left:308px;top:538px;width:28px;height:52px;/*Add Style*/">
			
			<!-- Trefle.JPG - Bitmap intégré pic_4 -->
			<img alt="T" src="Trefle.jpg" __AddCode="here" style="position:absolute;left:308px;top:592px;width:28px;height:52px;/*Add Style*/">
			
			<!--Preamble for Zone de texte - EST txt_8
			<div class="OBJ-8" __AddCode="here" style="position:absolute;left:653px;top:262px;width:302px;height:41px;overflow:hidden;/*Add Style*/">
				<p class="Corps P-1"><span class="C-1">EST</span></p>
			</div>
			
			<!--Preamble for Zone de texte - SUD txt_9
			<div class="OBJ-2" __AddCode="here" style="position:absolute;left:298px;top:808px;width:345px;height:41px;overflow:hidden;/*Add Style*/">
				<p class="Corps P-1"><span class="C-1">SUD</span></p>
			</div>
			
			
			<!-- Carreau.JPG - Bitmap intégré pic_18 
			<img alt="" src="Carreau.jpg" __AddCode="here" style="position:absolute;left:416px;top:230px;width:28px;height:52px;border:1px groove #000000;/*Add Style*/">
			
			<!-- Coeur.JPG - Bitmap intégré pic_19 
			<img alt="" src="Coeur.jpg" __AddCode="here" style="position:absolute;left:341px;top:300px;width:28px;height:52px;border:1px groove #000000;/*Add Style*/">
			
			<!-- Trefle.JPG - Bitmap intégré pic_20 
			<img alt="" src="trefle.jpg" __AddCode="here" style="position:absolute;left:520px;top:300px;width:28px;height:52px;border:1px groove #000000;/*Add Style*/">
			
			<!-- Pique.JPG - Bitmap intégré pic_21 
			<img alt="" src="Pique.jpg" __AddCode="here" style="position:absolute;left:416px;top:360px;width:28px;height:52px;border:1px groove #000000;/*Add Style*/">
			-->
			
			<!--Zone de texte 10-->
			<div class="OBJ-9" __AddCode="here" style="position:absolute;left:444px;top:230px;width:28px;height:52px;overflow:hidden; text-align:center;border:1px groove #000000;/*Add Style*/">
				<p class="Corps"><span class="C-3"></span></p>
			</div>
			
			<!--Zone de texte 11-->
			<div class="OBJ-9" __AddCode="here" style="position:absolute;left:548px;top:300px;width:28px;height:52px;overflow:hidden; text-align:center;border:1px groove #000000;/*Add Style*/">
				<p class="Corps"><span class="C-3"></span></p>
			</div>
			
			<!--Zone de texte _12-->
			<div class="OBJ-9" __AddCode="here" style="position:absolute;left:444px;top:360px;width:28px;height:52px;overflow:hidden; text-align:center;border:1px groove #000000;/*Add Style*/">
				<p id="demo" onclick="Fonctionclick()">class="Corps"<span class="C-3"></span></p>
			</div>
			...
			<!--Zone de texte 15-->
			<div class="OBJ-9" __AddCode="here" style="position:absolute;left:416px;top:230px;width:28px;height:52px;overflow:hidden; text-align:center;border:1px groove #000000;/*Add Style*/">
				<p class="Corps"><span class="C-3"></span></p>
			</div>
			
			<!--Zone de texte 16-->
			<div class="OBJ-9" __AddCode="here" style="position:absolute;left:520px;top:300px;width:28px;height:52px;overflow:hidden; text-align:center;border:1px groove #000000;/*Add Style*/">
				<p class="Corps"><span class="C-3"></span></p>
			</div>
			
			<!--Zone de texte _17-->
			<div class="OBJ-9" __AddCode="here" style="position:absolute;left:416px;top:360px;width:28px;height:52px;overflow:hidden; text-align:center;border:1px groove #000000;/*Add Style*/">
				<p class="Corps"><span class="C-3"></span></p>
			</div>
						
			<!--Bouton Avance. - Bitmap intégré pic_22-->
			<img src="Avance.jpg" __AddCode="here" onclick=";" style="position:absolute;left:540px;top:370px;width:44px;height:34px;border:1px groove #000000;/*Add Style*/">
			
			<!-- Retour début.JPG - Bitmap intégré pic_23 -->
			<img alt="" src="Retour début.jpg" __AddCode="here" style="position:absolute;left:340px;top:368px;width:44px;height:34px;border:1px groove #000000;/*Add Style*/">
