...
<main class="mdl-layout__content">
   ...
   'user_nom'
 ]; ?>" <?php } ?> required style="border-bottom: 1px solid #003D00;width: 40%" class="mdl-textfield__input" type="text" name="nom">
   ...
   'user_prenom'
 ]; ?>" <?php } ?> required style="border-bottom: 1px solid #003D00; width: 30%" class="mdl-textfield__input" type="text" name="prenom">
   ...
   'user_mail'
 ]; ?>" <?php } ?> required style="border-bottom: 1px solid #003D00; width: 60%" class="mdl-textfield__input" type="email" name="mail">
