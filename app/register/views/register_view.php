...
<article>
    ...
    <form action="register" method="post">
        ...
        <input required type="text" name="nom" id="nom" placeholder="Exemple : Martin" value="<?= htmlspecialchars($form_data['nom'] ?? '') ?>">

        <label for="prenom">Prénom :</label>
        <input required type="text" name="prenom" id="prenom" placeholder="Exemple : Jacques" value="<?= htmlspecialchars($form_data['prenom'] ?? '') ?>">

        <label for="login">Adresse mail :</label>
        <input required type="email" name="login" id="login" placeholder="Exemple : jacques.martin@email.com" value="<?= htmlspecialchars($form_data['login'] ?? '') ?>">
