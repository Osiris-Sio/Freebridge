...
<section>
    <header>
        <h1>Mon Compte</h1>
        <p>Heureux de vous revoir, <strong><?php echo htmlspecialchars($_SESSION['user_prenom'] . ' ' . $_SESSION['user_nom']); ?></strong> !</p>
    </header>
    ...
    <div class="grid">
        ...
        <article>
            ...
            <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_subscr-find&alias=<?php echo getenv('PAYPAL_UNSUBSCRIBE_ALIAS'); ?>" class="outline contrast" style="display: block; text-align: center;">
        ...
        <article>
            ...
            <div>
                <p>Votre rang : <br>
                    <kbd><?php echo strtoupper($_SESSION['user_rang'] ?? 'INACTIF'); ?></kbd>
                </p>
                <p>Inscrit depuis le : <?php echo $_SESSION['user_date'] ?? 'Inconnue'; ?></p>
            </div>
        </article>
    </div>
    ...
    <div class="grid">
        ...
        <article>
            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                ...
                <input type="hidden" name="hosted_button_id" value="<?php echo getenv('PAYPAL_BUTTON_ID_PROGRESSER'); ?>">
        ...
        <article>
            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                <input type="hidden" name="cmd" value="_s-xclick">
                <input type="hidden" name="hosted_button_id" value="<?php echo getenv('PAYPAL_BUTTON_ID_PEAUFINER'); ?>">
                <input type="hidden" name="currency_code" value="EUR">
        ...
        <article>
            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                <input type="hidden" name="cmd" value="_s-xclick">
                <input type="hidden" name="hosted_button_id" value="<?php echo getenv('PAYPAL_BUTTON_ID_CONFIRMER'); ?>">
                <input type="hidden" name="currency_code" value="EUR">
