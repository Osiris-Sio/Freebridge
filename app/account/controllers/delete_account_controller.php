...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_delete'])) {
  ...
  try {
    ...
    if (
      ...
      $_SESSION['messages']['errors'][] =
        'Le mot de passe saisi est incorrect. Suppression annulée.';
      header('Location: delete_account');
      exit();
    }
    ...
    $_SESSION['messages']['errors'][] =
      'Une erreur est survenue lors de la suppression de votre compte. Veuillez contacter un administrateur si le problème persiste.';
